...
#define __STDSANMATIEMATICSVECTOR_H__
		...
		public:
			SPOINT2();
			explicit SPOINT2(const SPOINT2 &Point2);
			...
			explicit SPOINT2(const sfloat x, const sfloat y);
			explicit SPOINT2(const sfloat* pArray);
			~SPOINT2();
		...
		public:
			...
			explicit SVECTOR2(const SVECTOR2 &Vec2);
			explicit SVECTOR2(const SVECTOR3 &Vec3);
			explicit SVECTOR2(const SVECTOR4 &Vec4);
			explicit SVECTOR2(const sfloat x, const sfloat y);
			explicit SVECTOR2(const sfloat* pArray);
			~SVECTOR2();
		...
		public:
			...
			explicit SPOINT3(const SPOINT3 &Point3);
			...
			explicit SPOINT3(const sfloat x, const sfloat y, const sfloat z);
			explicit SPOINT3(const sfloat* pArray);
			~SPOINT3();
		...
		public:
			...
			explicit SVECTOR3(const SVECTOR3 &Vec3);
			explicit SVECTOR3(const SVECTOR4 &Vec4);
			explicit SVECTOR3(const sfloat x, const sfloat y, const sfloat z);
			explicit SVECTOR3(const sfloat* pArray);
			~SVECTOR3();
		...
		public:
			...
			explicit SPOINT4(const SPOINT4 &Point4);
			...
			explicit SPOINT4(const sfloat x, const sfloat y, const sfloat z, const sfloat w);
			explicit SPOINT4(const sfloat* pArray);
			~SPOINT4();
		...
		public:
			...
			explicit SVECTOR4(const SVECTOR4 &Vec4);
			explicit SVECTOR4(const sfloat x, const sfloat y, const sfloat z, const sfloat w);
			explicit SVECTOR4(const sfloat* pArray);
			~SVECTOR4();
