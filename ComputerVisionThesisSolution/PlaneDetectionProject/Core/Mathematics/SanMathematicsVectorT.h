...
#pragma endregion
		...
		public:
			_SPOINT2();
			explicit _SPOINT2(const _SPOINT2<ST, _Zero, _One> &Point2);
			...
			explicit _SPOINT2(const ST &x, const ST &y);
			explicit _SPOINT2(const ST* pArray);
			~_SPOINT2();
...
#pragma endregion
		...
		public:
			...
			explicit _SVECTOR2(const _SVECTOR2<ST, _Zero, _One> &Vec2);
			explicit _SVECTOR2(const _SVECTOR3<ST, _Zero, _One> &Vec3);
			explicit _SVECTOR2(const _SVECTOR4<ST, _Zero, _One> &Vec4);
			explicit _SVECTOR2(const ST &x, const ST &y);
			explicit _SVECTOR2(const ST* pArray);
			~_SVECTOR2();
			...
			bool operator==(const _SVECTOR3<ST, _Zero, _One> &Vec2) const;
			bool operator!=(const _SVECTOR3<ST, _Zero, _One> &Vec2) const;
...
#pragma region _SVECTOR2 CPP file
		...
		{
			return _SPOINT2<ST, _Zero, _One>(this->x + Vec2.x, this->y + Vec2.y);
		}
		template<class ST, class _Zero, class _One>
		_SVECTOR2<ST, _Zero, _One> _SVECTOR2<ST, _Zero, _One>::operator-(const _SVECTOR2<ST, _Zero, _One> &Vec2) const
		{
		...
		template<class ST, class _Zero, class _One>
		bool _SVECTOR2<ST, _Zero, _One>::operator==(const _SVECTOR3<ST, _Zero, _One> &Vec2) const
		{
...
#pragma endregion
		...
		public:
			...
			explicit _SPOINT3(const _SPOINT3<ST, _Zero, _One> &Point3);
			...
			explicit _SPOINT3(const ST &x, const ST &y, const ST &z);
			explicit _SPOINT3(const ST* pArray);
			~_SPOINT3();
...
#pragma region _SPOINT3 CPP file
		template<class ST, class _Zero, class _One>
		_SPOINT3<ST, _Zero, _One>::_SPOINT3()
...
#pragma endregion
		...
		public:
			...
			explicit _SVECTOR3(const _SVECTOR3<ST, _Zero, _One> &Vec3);
			explicit _SVECTOR3(const _SVECTOR4<ST, _Zero, _One> &Vec4);
			explicit _SVECTOR3(const ST &x, const ST &y, const ST &z);
			explicit _SVECTOR3(const ST* pArray);
			~_SVECTOR3();
...
#pragma region _SVECTOR3 CPP file
		template<class ST, class _Zero, class _One>
		_SVECTOR3<ST, _Zero, _One>::_SVECTOR3()
			:_stSPOINT3<ST>(_Zero(), _Zero(), _Zero())
		{
		}
		template<class ST, class _Zero, class _One>
		...
		{
			return _SPOINT3<ST, _Zero, _One>(this->x + Vec3.x, this->y + Vec3.y, this->z + Vec3.z);
		}
		template<class ST, class _Zero, class _One>
		_SVECTOR3<ST, _Zero, _One> _SVECTOR3<ST, _Zero, _One>::operator-(const _SVECTOR3<ST, _Zero, _One> &Vec3) const
		{
...
#pragma endregion
		...
		public:
			...
			explicit _SPOINT4(const _SPOINT4<ST, _Zero, _One> &Point4);
			...
			explicit _SPOINT4(const ST &x, const ST &y, const ST &z, const ST &w);
			explicit _SPOINT4(const ST* pArray);
			~_SPOINT4();
...
#pragma region _SPOINT4 CPP file
		template<class ST, class _Zero, class _One>
		_SPOINT4<ST, _Zero, _One>::_SPOINT4()
...
#pragma endregion
		...
		public:
			...
			explicit _SVECTOR4(const _SVECTOR4<ST, _Zero, _One> &Vec4);
			explicit _SVECTOR4(const ST &x, const ST &y, const ST &z, const ST &w);
			explicit _SVECTOR4(const ST* pArray);
			~_SVECTOR4();
...
#pragma region _SVECTOR4 CPP file
		template<class ST, class _Zero, class _One>
		_SVECTOR4<ST, _Zero, _One>::_SVECTOR4()
			:_stSPOINT4<ST>(_Zero(), _Zero(), _Zero(), _Zero())
		{
		}
		template<class ST, class _Zero, class _One>
